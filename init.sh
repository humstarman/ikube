...
sleep $WAIT 
TEXT="finished_install_kubernetes_at_$(date -d today +'%Y-%m-%d_%H:%M:%S')"
curl https://sc.ftqq.com/SCU31080T5747dd558f09b5ecab28adf0b081d80b5b7cdf2331e11.send?text=${TEXT}
exit 0
